...
<tr>
  <td>
    ...
    <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td bgcolor="#3c8dbc" class="header">
            ...
            <tr>
              <td height="70">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td class="h1" style="padding: 5px 0 0 0; color: #fff !important;">
                      Nueva notificación
                    </td>
                  </tr>
                </table>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr style="background: #ECF0F5;">
              <td class="h2">
                  ¡Hola!
                <br>
                Se te ha añadido un nuevo reporte general.
              </td>
            </tr>
            <tr style="background:#ECF0F5;">
              <td class="bodycopy">
                Podras ver este reporte a partir de la siguiente fecha: <?php echo $fecha; ?>.
              </td>
            </tr>
          </table>
        </td>
      ...
      <tr>
        <td class="footer" bgcolor="#20313c">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="center" class="footercopy">
                &reg; ARS Quality Services 2017<br/>
                  ...
                  <tr>
                    <td width="37" style="text-align: center; padding: 0 10px 0 10px;">
                      <a href="http://www.facebook.com/">
                        ...
                        <img width="80" height="80" src="assets/imagenes/logo.png" alt="ARS Logo">
                      </a>
                    </td>
                  </tr>
                </table>
