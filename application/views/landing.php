...
<head>
    ...
    <title>ECONOLENTES espress</title>
...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav" style="background: rgba(233, 236, 239, 0.99) !important;">
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            <img src="/assets/img/logo.png" class="" height="52px" alt="">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto" style="color: rgba(255, 255, 255, 0.7) !important;">
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger menu-a" href="/login">Iniciar Sesión</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link js-scroll-trigger menu-a" href="#contact">Contacto</a>
                </li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="device-mockup iphone6_plus portrait white">
                        <div class="device">
                            <div class="screen">
                                ...
                                <img src="/assets/img/atras.png" class="img-fluid" alt="">
                            </div>
                            <div class="button">
...
<img src="/assets/img/fondolentes.png" class="" height="52px" alt="">
...
<footer>
    <div class="container">
        <p>&copy; 2017 ECONOLENTES espress. All Rights Reserved.</p>
